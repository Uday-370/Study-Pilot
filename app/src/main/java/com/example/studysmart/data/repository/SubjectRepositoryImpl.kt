...
import com.example.studysmart.data.local.ResourceDao // 🚀 IMPORT THIS
...
class SubjectRepositoryImpl @Inject constructor(
    ...
    private val resourceDao: ResourceDao // 🚀 INJECT THIS
): SubjectRepository {
    ...
    override suspend fun deleteSubject(subjectId: Int) {
        ...
        // 🚀 PREVENT MEMORY LEAKS: Delete the materials attached to this class!
        resourceDao.deleteResourcesBySubjectId(subjectId)
